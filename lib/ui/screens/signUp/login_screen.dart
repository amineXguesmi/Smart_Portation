...
import 'package:transportation/ui/screens/home_screen.dart';
import 'package:transportation/ui/screens/signUp/signup_process.dart';
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              icon: Icon(Icons.mail, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            textInputAction: TextInputAction.done,
                            decoration: InputDecoration(
                              icon: Icon(Icons.password, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                              hintText: "Password",
                              hintStyle: TextStyle(
                                fontSize: deviceWidth * 0.03,
                                fontWeight: FontWeight.w600,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const Text(
                              ' Or sign up with',
                              style: TextStyle(color: Color(0xFF2E9965)),
                            ),
                            Container(
                              height: deviceHeight * 0.002,
                              width: deviceWidth * 0.13,

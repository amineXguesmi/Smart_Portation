            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  icon: Icon(Icons.alternate_email, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                  hintText: "Email",
                  hintStyle: TextStyle(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide:
                        BorderSide(color: _emailEmpty || _emailError != '' ? Colors.red : const Color(0xFF1CAAC9)),
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: _emailMatch ? const Color(0xFF1CAAC9) : Colors.red),
                    borderRadius: BorderRadius.circular(deviceWidth * 0.03),
                    gapPadding: 0,
                  ),
                  fillColor: Colors.white,

          ...
          children: [
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  icon: Icon(Icons.person, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                  hintText: "first name",
                  hintStyle: TextStyle(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: nameError != '' || nameEmpty ? Colors.red : const Color(0xFF1CAAC9)),
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                textInputAction: TextInputAction.done,
                decoration: InputDecoration(
                  icon: Icon(Icons.person_outline_rounded, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                  hintText: "last name",
                  hintStyle: TextStyle(
                    fontSize: deviceWidth * 0.04,
                    fontWeight: FontWeight.w600,

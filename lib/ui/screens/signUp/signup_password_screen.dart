            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  icon: Icon(Icons.password_sharp, color: const Color(0xFF1CAAC9), size: deviceWidth * 0.06),
                  hintText: "Password",
                  hintStyle: TextStyle(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide:
                        BorderSide(color: passwordEmpty || textError != '' ? Colors.red : const Color(0xFF1CAAC9)),
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: passwordMatch ? const Color(0xFF1CAAC9) : Colors.red),
                    borderRadius: BorderRadius.circular(deviceWidth * 0.03),
                    gapPadding: 0,
                  ),
                  fillColor: Colors.white,
